...
/**
 * @brief voidbots bot list
 */
struct voidbots : public botlist {
	static constexpr std::string_view name{"voidbots.net"};
	static constexpr std::string_view url{"https://api.voidbots.net/bot/stats/{}"};
