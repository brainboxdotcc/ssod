...
/**
 * @brief botlist.me bot list
 */
struct botlistme : public botlist {
	static constexpr std::string_view name{"botlist.me"};
	static constexpr std::string_view url{"https://api.botlist.me/api/v1/bots/{}/stats"};
