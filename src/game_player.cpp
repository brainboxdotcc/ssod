...
dpp::message player::get_magic_selection_message(dpp::cluster& cluster, const dpp::interaction_create_t &event) {
	...
	const std::vector<dpp::select_option> all_spells{
		dpp::select_option("FIRE", "fire", ""),
		dpp::select_option("WATER", "water", ""),
		dpp::select_option("LIGHT", "light", ""),
		dpp::select_option("FLY", "fly", ""),
		dpp::select_option("STRENGTH", "strength", ""),
		dpp::select_option("XRAY", "xray", ""),
		dpp::select_option("BOLT", "bolt", ""),
		dpp::select_option("FASTHANDS", "fasthands", ""),
		dpp::select_option("THUNDERBOLT", "thunderbolt", ""),
		dpp::select_option("STEAL", "steal", ""),
		dpp::select_option("SHIELD", "shield", ""),
		...
		dpp::select_option("ESP", "esp", "Allows the caster to read minds"),
		...
		dpp::select_option("ANIMAL", "animalcommunication", "Talk to animals. Does what it says on the tin."),
		dpp::select_option("WEAPONSKILL", "weaponskill", "A temporary boost in weapons proficiency"),
		...
		dpp::select_option("NIGHTVISION", "nightvision", "Allows the caster to see in the dark"),
		dpp::select_option("HEATEYES", "heateyes", "Project blazing heat from the caster's eyeballs"),
		dpp::select_option("DECHIPHER", "decipher", "Read what others cannot"),
		...
		dpp::select_option("ESPSURGE", "espsurge", "A psychic blast that can destroy minds and sanity"),
		dpp::select_option("AFTERIMAGE", "afterimage", "Project ghost-like copies of yourself behind you as you move"),
		dpp::select_option("PSYCHISM", "psychism", "Allows a glimpse into the realm beyond"),
		dpp::select_option("SPIRITWALK", "spiritwalk", "Leave your body to see places physically far away"),
		dpp::select_option("GROWWEAPON", "growweapon", "Make your weapons bigger. Good luck using them!"),
	};
