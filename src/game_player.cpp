...
dpp::message player::get_magic_selection_message(dpp::cluster& cluster, const dpp::interaction_create_t &event) {
	...
	const std::vector<dpp::select_option> all_spells{
		dpp::select_option("FIRE", "fire", "FIRED"),
		dpp::select_option("WATER", "water", "WATERD"),
		dpp::select_option("LIGHT", "light", "LIGHTD"),
		dpp::select_option("FLY", "fly", "FLYD"),
		dpp::select_option("STRENGTH", "strength", "STRENGTHD"),
		dpp::select_option("XRAY", "xray", "XRAYD"),
		dpp::select_option("BOLT", "bolt", "BOLTD"),
		dpp::select_option("FASTHANDS", "fasthands", "FASTHANDSD"),
		dpp::select_option("THUNDERBOLT", "thunderbolt", "THUNDERBOLTD"),
		dpp::select_option("STEAL", "steal", "STEALD"),
		dpp::select_option("SHIELD", "shield", "SHIELDD"),
		dpp::select_option("JUMP", "jump", "JUMPD"),
		dpp::select_option("OPEN", "open", "OPEND"),
		dpp::select_option("SPOT", "spot", "SPOTD"),
		dpp::select_option("SNEAK", "sneak", "SNEAKD"),
		dpp::select_option("ESP", "esp", "ESPD"),
		dpp::select_option("RUN", "run", "RUND"),
		dpp::select_option("INVISIBLE", "invisible", "INVISIBLED"),
		dpp::select_option("SHRINK", "shrink", "SHRINKD"),
		dpp::select_option("GROW", "grow", "GROWD"),
		dpp::select_option("AIR", "air", "AIRD"),
		dpp::select_option("ANIMAL", "animalcommunication", "ANIMALD"),
		dpp::select_option("WEAPONSKILL", "weaponskill", "WEAPONSKILLD"),
		dpp::select_option("HEALING", "healing", "HEALINGD"),
		dpp::select_option("WOODSMANSHIP", "woodsmanship", "WOODSMANSHIPD"),
		dpp::select_option("NIGHTVISION", "nightvision", "NIGHTVISIOND"),
		dpp::select_option("HEATEYES", "heateyes", "HEATEYESD"),
		dpp::select_option("DECHIPHER", "decipher", "DECIPHERD"),
		dpp::select_option("DETECT", "detect", "DETECTD"),
		dpp::select_option("TRACKING", "tracking", "TRACKINGD"),
		dpp::select_option("ESPSURGE", "espsurge", "ESPSURGED"),
		dpp::select_option("AFTERIMAGE", "afterimage", "AFTERIMAGED"),
		dpp::select_option("PSYCHISM", "psychism", "PSYCHISMD"),
		dpp::select_option("SPIRITWALK", "spiritwalk", "SPIRITWALKD"),
		dpp::select_option("GROWWEAPON", "growweapon", "GROWWEAPOND"),
	};
